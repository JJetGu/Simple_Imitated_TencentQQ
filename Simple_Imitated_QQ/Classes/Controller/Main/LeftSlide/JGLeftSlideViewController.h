...
#define kMainPageDistance   100   //打开左侧窗时，右视图露出的宽度
#define kMainPageScale   0.8  //打开左侧窗时，右视图缩放比例
...
@interface JGLeftSlideViewController : UIViewController
 ...
 *  初始化侧滑控制器
 *
 *  @param leftVC 左边视图控制器
 *  @param mainVC 中间视图控制器
 *
 *  @return 初始化生成的对象
 */
